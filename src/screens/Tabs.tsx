      ...
      >
        ...
        >
          <Tab
            ...
            {...a11yProps(0)}
            color="black"
            sx={{ fontSize: 15, textTransform: 'capitalize', fontWeight: 500 }}
          />
        </Tabs>
      </Box>
      <CustomTabPanel value={value} index={0}>
        <Grid container justifyContent="space-between">
          <Grid item xs={12} md={8}>
            ...
            <Typography variant="h6" textAlign="left" mt={4}>
              Informatat{' '}
            </Typography>
            <Grid container spacing={2} sx={{ flexGrow: 1 }}>
              <Grid item xs={12} md={6}>
                ...
                <Box display="inline-flex" flexGrow={1} width="100%" my={1}>
                  <BedroomParentIcon />
                  <Typography ml={1}>
                    {item.rooms[0]} - {item.rooms[item.rooms.length - 1]} dhoma
                  </Typography>
                </Box>
                <Box display="inline-flex" flexGrow={1} width="100%" my={1}>
                  <GroupsIcon />
